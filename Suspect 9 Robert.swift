  ...
  //  @Binding var wordplay: WordPlay
    var body: some View {
        ...
        ZStack{
            Rectangle()
            VStack{
                Text("Joel: I was looking for a history book about WW2 but sadly it was aready checked out")
                Divider()
                Text("Freddy: I was looking around for a book")
                Divider()
                ...
                Divider()
                Text("Johnny: I wasn't even in the history section, i only walked by it and went to the fiction section.")
